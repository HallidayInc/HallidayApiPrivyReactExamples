      ...
      <div id="input-screen" className="container">
        ...
        <div className="confirm-content">
          <div className="input-label">
            Privy wallet address to onramp $MEGA to on MegaETH. This Privy wallet address will own the payment, <a href="https://docs.halliday.xyz/pages/otw" target="_blank" rel="noreferrer">learn more here</a>.
          </div>
